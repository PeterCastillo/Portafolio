...
const grades: Array<EstudioTypes> = [
    {
        logo: "https://codigo.edu.pe/public/img/codigo-logo.png",
        estudioName: "Desarrollador Front-End",
        estudioEspefic: "JS, TS, ReactJs, GitHub",
        estudioDate: "2022 - 2022",
        estudioInfo: [
    ...
    },
    {
        ...
        estudioEspefic: "Java, BD relacional",
        estudioDate: "2019 - 2022",
        estudioInfo: [
    ...
    },
    {
        ...
        estudioName: "Ingles",
        estudioEspefic: "Ingles",
        estudioDate: "2019 - 2021",
        estudioInfo: [
